...
namespace Uno.UI.RuntimeTests.Tests.Windows_UI_Xaml_Controls
{
	...
	public partial class Given_ListViewBase // test cases
	{
		...
		public async Task When_Large_List_Scroll_To_End_Then_Back_Up_TryClick()
		{
			...
			ImageAssert.DoesNotHaveColorInRectangle(si, new Rect(100, 110, si.Width - 100, si.Height - 110), Colors.FromARGB("#66AEE7")); // selected
			ImageAssert.DoesNotHaveColorInRectangle(si, new Rect(100, 110, si.Width - 100, si.Height - 110), Colors.FromARGB("#FFE6E6E6")); // hovered
		}
